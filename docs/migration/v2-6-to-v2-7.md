...
See [Tool reference](../reference/tool.md).
...
- [Agent reference](../reference/agent.md) — the page that replaced the `createAgent` reference
...
- [Stores reference](../reference/stores.md) — the page that replaced the adapters reference
